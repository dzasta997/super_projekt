...
def main():
    ...
    try:
        ...
        # GET ALL LOCATIONS IN WAREHOUSE AND CHECK IF THEY HAVE NECESSARY INFORMATION TO DETERMINE NEW ITEM'S LOCATION
        ...
        if len(locations) != 1:
            raise Exception("AMOUNT OF LOCATIONS NOT RIGHT")
